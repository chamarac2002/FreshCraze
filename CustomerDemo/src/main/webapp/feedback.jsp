...
<form name="feedbackForm" action="feedback" method="post" onsubmit="return validateForm()">
	<table class = "table">
		...
		<tr class="active-row">
			<td>Subject:</td>
			<td><input type="text" name="subject" placeholder="Enter feedback subject" ></td>
		</tr>
		<tr>
			<td>Message:</td>
			<td><textarea name="message" rows="5" cols="20" placeholder="Write your valuable feedback" ></textarea></td>
		</tr>
		<tr class="active-row">
			<td>Do you satisfy with our service:</td>
			<td><input type="text" name="question" placeholder="Yes or No" ></td>
		</tr>
    </tbody>
	</table>
